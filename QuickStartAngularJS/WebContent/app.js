...
/**
 * Instead of using this global spacename as controllers and variables container,
 *  we are going to use modules
 */
var myApp = angular.module("myMainAppModule", ["ngRoute"]);
...
myApp.factory("bookListSrvc", function() {
	var books= [
	    		{
...
myApp.factory("kartListSrvc", function() {
...
myApp.controller("BookListCtrl", function($scope,$filter,bookListSrvc,kartListSrvc) {
	$scope.books = bookListSrvc.getBooks();
	$scope.addToKart = function(book){
		kartListSrvc.addToKart(book);
	}
});

myApp.controller("KartListCtrl", function($scope,kartListSrvc){
	$scope.kart = kartListSrvc.getKart();
	$scope.buy = function(book){
		kartListSrvc.buy(book);
	}	
});